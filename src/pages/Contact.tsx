...
export default function ContactManagement() {
  const [contacts, setContacts] = useState([
    { id: 1, name: 'Eska kya Name hai', number: '+919888776655', status: 'to be called' },
    { id: 2, name: 'Eska kya Name hai', number: '+919888776655', status: 'followed' },
    { id: 3, name: 'Eska kya Name hai', number: '+919888776655', status: 'to be called' },
    { id: 4, name: 'Eska kya Name hai', number: '+919888776655', status: 'donated' },
  ]);
      ...
      <div className="p-4 text-[#4a6fa5]">
        <div className="bg-[#daeeff] flex items-center justify-between p-3 rounded-xl">
          ...
          <div className="w-auto">
            {/* <h2 className="text-xl font-bold mb-1">MANAGE YOUR CONTACTS</h2> */}
            <p className="text-xs">
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
          <div className="bg-[#c0e2ff] rounded-xl p-6 w-full max-w-md">
            {/* <h2 className="text-xl font-bold mb-4">{currentContact ? 'Edit Contact' : 'Add Contact'}</h2> */}
            <form onSubmit={(e) => {
              e.preventDefault();
              ...
              <div className="mb-4">
                <label className="lock text-lg text-[#4a6fa5] font-bold">Number</label>
                <input
                  type="text"
                  name="number"
              ...
              <div className="mb-4">
                <label className="lock text-lg text-[#4a6fa5] font-bold">Note</label>
                <input
                  type="text"
                  name="notes"
              ...
              <div className="mb-4">
                <label className="lock text-lg text-[#4a6fa5] font-bold">Status</label>
                <select
                  name="status"
