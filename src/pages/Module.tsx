...
export default function ModulePlayer() {
  ...
  const saveProgress = async (progressPercentage: number, position: number, completed: boolean) => {
        ...
        <div className="space-y-6">
          ...
          <div>
            <div className='p-2 bg-white shadow-lg rounded-2xl'>
                <h3 className="text-[#69b0ee] font-bold mb-1">MODULE {module.number}: {module.title}</h3>
          ...
          <div className='rounded-2xl p-2 bg-white border-[#69b0ee] border-2'>
          {/* Video Player */}
            ...
            {module.description && (
                ...
                <h3 className="font-bold text-[#69b0ee] mb-2">Description:</h3>
                <p className="text-[#5578ab]">{module.description}</p>
                </div>
            )}
          ...
          <div className="border-t pt-6 mt-6">
            <div className='flex items-center justify-center'>
                <span className="text-2xl font-bold text-[#ee6969] mb-4">The </span>
                <span className='text-2xl font-bold text-[#69b0ee] mb-4'> Manifestation Wall! ✨</span>
            </div>
              ...
              <div className="flex items-start gap-3 ">
                ...
                <button
                  ...
                  className={`bg-red-500 text-white rounded-lg px-4 py-2 text-sm flex items-center gap-1 ${
                    !newComment.trim() || submittingComment ? 'opacity-50' : 'hover:bg-red-600'
                  }`}
                >
                  <Send size={16} />
                  <span>Send</span>
