/*
  # Add missing RLS policies safely
  
  This migration adds Row Level Security (RLS) policies for tables that are missing them,
  checking for existence first to avoid conflicts.
  
  1. Policies Added:
    - Assignment options: View access for authenticated users
    - Assignment questions: View access for authenticated users  
    - Assignments: View access for authenticated users
    - Comment reactions: View, create and delete access for authenticated users
    - Community comments: View and create access for authenticated users
    - Donation stats: View access for authenticated users
    - Donations: View and create access for authenticated users
    - User ranks: View access for authenticated users
*/
