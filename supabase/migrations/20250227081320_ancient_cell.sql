/*
  # Create children table and add sample data
...
DO $$ 
BEGIN
  DROP POLICY IF EXISTS "Children are viewable by authenticated users" ON children;
...
-- Insert sample children data only if the table is empty
DO $$
BEGIN
